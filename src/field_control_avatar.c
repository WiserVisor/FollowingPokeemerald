...
int ProcessPlayerFieldInput(struct FieldInput *input)
{
    ...
    if (input->tookStep)
    {
			...
			&& gSaveBlock2Ptr->follower.comeOutDoorStairs == 0)
		{
			...
			{
				case 1: // South
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.x = gSprites[gPlayerAvatar.spriteId].pos1.x;
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.y = gSprites[gPlayerAvatar.spriteId].pos1.y - 16;
					break;
				case 2: // North
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.x = gSprites[gPlayerAvatar.spriteId].pos1.x;
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.y = gSprites[gPlayerAvatar.spriteId].pos1.y + 16;
					break;
				case 3: // West
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.x = gSprites[gPlayerAvatar.spriteId].pos1.x + 16;
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.y = gSprites[gPlayerAvatar.spriteId].pos1.y;
					break;
				case 4: // East
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.x = gSprites[gPlayerAvatar.spriteId].pos1.x - 16;
					gSprites[gObjectEvents[gSaveBlock2Ptr->follower.objId].spriteId].pos1.y = gSprites[gPlayerAvatar.spriteId].pos1.y;
