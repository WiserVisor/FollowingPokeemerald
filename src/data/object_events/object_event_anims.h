...
const union AnimCmd gObjectEventImageAnim_FaceNorth_Double_FollowingPokemon[] =
{
	...
	ANIMCMD_FRAME(2, 14, .hFlip = TRUE),
	ANIMCMD_FRAME(3, 14, .hFlip = TRUE),
	ANIMCMD_JUMP(0),
};
...
{
	ANIMCMD_FRAME(8, 14, .hFlip = TRUE),
	ANIMCMD_FRAME(9, 14, .hFlip = TRUE),
	ANIMCMD_FRAME(10, 14, .hFlip = TRUE),
	ANIMCMD_FRAME(11, 14, .hFlip = TRUE),
	ANIMCMD_JUMP(0),
};
...
const union AnimCmd gObjectEventImageAnim_WalkNorth_Double_FollowingPokemon[] =
{
	...
	ANIMCMD_FRAME(1, 7, .hFlip = TRUE),
	ANIMCMD_FRAME(2, 7, .hFlip = TRUE),
	ANIMCMD_FRAME(3, 7, .hFlip = TRUE),
	ANIMCMD_JUMP(0),
};
...
const union AnimCmd gObjectEventImageAnim_WalkEast_FollowingPokemon[] =
{
	...
	ANIMCMD_FRAME(9, 7, .hFlip = TRUE),
	ANIMCMD_FRAME(10, 7, .hFlip = TRUE),
	ANIMCMD_FRAME(11, 7, .hFlip = TRUE),
	ANIMCMD_JUMP(0),
};
...
const union AnimCmd gObjectEventImageAnim_WalkNorthFast_Double_FollowingPokemon[] =
{
	...
	ANIMCMD_FRAME(2, 3, .hFlip = TRUE),
	ANIMCMD_FRAME(3, 3, .hFlip = TRUE),
	ANIMCMD_JUMP(0),
};
