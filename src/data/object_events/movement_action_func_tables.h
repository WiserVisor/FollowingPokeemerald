...
u8 MovementAction_FollowingPokemon_Step1(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_FollowingPokemon_Step2(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_FollowingPokemon_Step3(struct ObjectEvent *, struct Sprite *);
u8 MovementAction_FollowingPokemon_Step4(struct ObjectEvent *, struct Sprite *);
